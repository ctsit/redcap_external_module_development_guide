...
Your new hire should not work alone. Connect them to the REDCap community. Sign them up for the REDCap Community website. Introduce them to developers you know so they can feel a part of that sub-community as well. Invite them to REDCapCon.
